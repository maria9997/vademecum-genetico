const drugsData = (function() {
    ...
    eculizumab.posologia.motor_dosificacion = {
        calculation_type: "BANDAS_EDAD_PESO", inputs_required: ["peso_kg"], fallback: { trigger: "NINGUN_TIER_COINCIDE", mensaje: "Peso no soportado.", accion_ui: "BLOQUEAR_CALCULO" },
        rules_matrix: [
            { tier: 1, conditions: { peso_kg: { operator: ">=", threshold: 40 } }, loading_output: { dose_description: "900 mg semanal x 4 dosis", mipres_monthly_boxes: 12, frequency_description: "Semanas 1 a 4" }, output: { posology_am: "1200 mg", mipres_monthly_boxes: 8, frequency_description: "Semana 5 y luego cada 2 semanas" } },
            { tier: 2, conditions: { peso_kg: { operator: "<", threshold: 40 } }, loading_output: { dose_description: "Ver posología pediátrica en ficha", mipres_monthly_boxes: 0, frequency_description: "" }, output: { posology_am: "Ver ficha", mipres_monthly_boxes: 0, frequency_description: "" } }
        ]
    };
    ...
    ravulizumab.posologia.motor_dosificacion = {
        calculation_type: "BANDAS_EDAD_PESO", inputs_required: ["peso_kg"], fallback: { trigger: "NINGUN_TIER_COINCIDE", mensaje: "Peso no soportado.", accion_ui: "BLOQUEAR_CALCULO" },
        rules_matrix: [
            { tier: 1, conditions: { peso_kg: { operator: ">=", threshold: 100 } }, loading_output: { dose_description: "3000 mg (Única dosis)", mipres_monthly_boxes: 10, frequency_description: "Día 1" }, output: { posology_am: "3600 mg", mipres_monthly_boxes: 12, frequency_description: "Día 15 y luego cada 8 semanas" } },
            { tier: 2, conditions: { peso_kg: { operator: ">=", threshold: 60 } }, loading_output: { dose_description: "2700 mg (Única dosis)", mipres_monthly_boxes: 9, frequency_description: "Día 1" }, output: { posology_am: "3300 mg", mipres_monthly_boxes: 11, frequency_description: "Día 15 y luego cada 8 semanas" } },
            { tier: 3, conditions: { peso_kg: { operator: ">=", threshold: 40 } }, loading_output: { dose_description: "2400 mg (Única dosis)", mipres_monthly_boxes: 8, frequency_description: "Día 1" }, output: { posology_am: "3000 mg", mipres_monthly_boxes: 10, frequency_description: "Día 15 y luego cada 8 semanas" } },
            { tier: 4, conditions: { peso_kg: { operator: "<", threshold: 40 } }, loading_output: { dose_description: "Ver ficha pediátrica", mipres_monthly_boxes: 0, frequency_description: "Día 1" }, output: { posology_am: "Ver ficha pediátrica", mipres_monthly_boxes: 0, frequency_description: "Día 15 y cada 4-8 sem" } }
        ]
    };
